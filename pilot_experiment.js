...
const PROLIFIC_COMPLETION_CODE = "CF9DHY34";
...
const data_filename = `${subject_id}_${session_id}_${Date.now()}_ultimatum_exp1_pilot10.csv`;
...
function buildConditionTable() {
  const pilotRows = [
    { split_id: "you30_other70", area_condition: "equal_radius", position_condition: "left", color_balance: "you_orange_other_blue" },
    { split_id: "you30_other70", area_condition: "equal_radius", position_condition: "right", color_balance: "you_blue_other_orange" },
    { split_id: "you30_other70", area_condition: "you_larger", position_condition: "left", color_balance: "you_orange_other_blue" },
    { split_id: "you30_other70", area_condition: "you_larger", position_condition: "right", color_balance: "you_blue_other_orange" },
    { split_id: "you30_other70", area_condition: "other_larger", position_condition: "left", color_balance: "you_orange_other_blue" },
    { split_id: "you30_other70", area_condition: "other_larger", position_condition: "right", color_balance: "you_blue_other_orange" },
    { split_id: "you40_other60", area_condition: "you_larger", position_condition: "left", color_balance: "you_blue_other_orange" },
    { split_id: "you40_other60", area_condition: "you_larger", position_condition: "right", color_balance: "you_orange_other_blue" },
    { split_id: "you40_other60", area_condition: "other_larger", position_condition: "left", color_balance: "you_blue_other_orange" },
    { split_id: "you40_other60", area_condition: "other_larger", position_condition: "right", color_balance: "you_orange_other_blue" }
  ];

  return pilotRows.map(function (pilot, index) {
    const area = areaConditions.find(row => row.area_condition === pilot.area_condition);
    const split = splits.find(row => row.split_id === pilot.split_id);
    const position = positions.find(row => row.position_condition === pilot.position_condition);
    const colors = colorBalances.find(row => row.color_balance === pilot.color_balance);
    return {
      condition_index: index,
      pilot_condition_index: index + 1,
      condition_label: `${pilot.area_condition}_${pilot.split_id}_${pilot.position_condition}_${pilot.color_balance}`,
      ...area,
      ...split,
      ...position,
      ...colors
...
function decisionTrial(condition) {
  ...
  return {
    ...
    data: {
      ...
      pilot_condition_index: condition.pilot_condition_index,
        ...
        button.addEventListener("click", function () {
          ...
          setTimeout(function () {
            jsPsych.finishTrial({
              ...
              decision_click_rt: clickRt,
              decision_page_rt: Math.round(performance.now() - pageStart)
            });
          }, 350);
        });
      });
  ...
  return {
    ...
    stimulus: shellHtml(`
      <form id="post-recall-form" novalidate>
        <h2 class="intro-title">Follow-up Questions</h2>
        <p class="muted post-instruction">Please answer based on your memory.</p>
        <div class="form-question">
          <label class="question-text" for="recall-you-cents">Please recall: According to the proposal, how many cents would you receive if you accepted?</label>
        ...
        <div class="form-question">
          <label class="question-text" for="recall-proposer-cents">Please recall: According to the proposal, how many cents would the proposer receive if you accepted?</label>
          <div class="numeric-answer-row">
  ...
  return {
    ...
    stimulus: shellHtml(`
      <form id="post-open-form" novalidate>
        ...
        <div class="form-question">
          <label class="question-text post-open-question" for="study-issue-comment">Please let us know if you experienced any issues or had any questions about the study you just completed.</label>
...
async function buildAndRunExperiment() {
  ...
  jsPsych.data.addProperties({
    ...
    pilot_condition_index: conditionInfo.pilot_condition_index,

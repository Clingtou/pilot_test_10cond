...
function buildConditionTable() {
  const pilotRows = [
    { split_id: "you10_other90", area_condition: "equal_radius", position_condition: "top", color_balance: "you_blue_other_orange" },
    { split_id: "you10_other90", area_condition: "you_larger", position_condition: "top", color_balance: "you_blue_other_orange" },
    { split_id: "you10_other90", area_condition: "you_larger", position_condition: "bottom", color_balance: "you_orange_other_blue" },
    { split_id: "you10_other90", area_condition: "other_larger", position_condition: "top", color_balance: "you_blue_other_orange" },
    { split_id: "you10_other90", area_condition: "other_larger", position_condition: "bottom", color_balance: "you_orange_other_blue" },
    { split_id: "you20_other80", area_condition: "equal_radius", position_condition: "bottom", color_balance: "you_orange_other_blue" },
    { split_id: "you20_other80", area_condition: "you_larger", position_condition: "top", color_balance: "you_orange_other_blue" },
    { split_id: "you20_other80", area_condition: "you_larger", position_condition: "bottom", color_balance: "you_blue_other_orange" },
    { split_id: "you20_other80", area_condition: "other_larger", position_condition: "top", color_balance: "you_orange_other_blue" },
    { split_id: "you20_other80", area_condition: "other_larger", position_condition: "bottom", color_balance: "you_blue_other_orange" }
  ];
  ...
  return {
    ...
    stimulus: shellHtml(`
      <form id="human-verification-form" class="human-verification-form" novalidate>
        ...
        <div class="single-choice-list verification-options" role="radiogroup" aria-label="Human verification">
        ...
        <button type="submit" class="form-submit verification-submit">Continue</button>
        <div id="verification-required" class="required-note">Please answer this question before continuing.</div>
      </form>
    `, STUDY_TITLE, "verification-shell"),
    choices: "NO_KEYS",
    data: { phase: "human_verification" },
    on_load: function () {
      const pageStart = performance.now();
      const form = document.getElementById("human-verification-form");
      const warning = document.getElementById("verification-required");
      form.addEventListener("submit", function (event) {
        event.preventDefault();
        const response = collectFormData(form).human_verification_response;
        if (!response) {

...
function buildConditionTable() {
  const pilotRows = [
    { split_id: "you30_other70", area_condition: "you_larger", position_condition: "bottom", color_balance: "you_blue_other_orange" },
    { split_id: "you30_other70", area_condition: "other_larger", position_condition: "bottom", color_balance: "you_blue_other_orange" }
  ];
